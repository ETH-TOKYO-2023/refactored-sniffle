...
import { herodotusProof, proofOfOG, proofOfSismoBadge, starknetVerify } from '../erc20/proofs'
...
const post = async (req: NextApiRequest, res: NextApiResponse<any>) => {
  ...
  const proofOG = await proofOfSismoBadge(contract_data.address, contract_data.genesisBlock, contract_data.storage_slot_balance, address)
